...
export const HighlightBox = ({
  ...
  return (
    <div
      className={`relative z-[1] ${getCardStyle()} border p-3 py-2 rounded shadow-md w-full sm:w-fit min-w-[150px]`}
    >
      <div
        className={`text-xs font-medium ${getCardStyle().includes("text-white") ? "text-white" : "text-gray-600"}`}
      >
        {label}
      </div>
