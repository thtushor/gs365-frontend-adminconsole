...
const AddSportProviderForm = ({
  ...
  const { data, isLoading, isError, error } = useQuery({
    ...
    queryFn: () =>
      getRequest({
        ...
        errorMessage: "Failed to fetch sport provider list list",
      }),
  ...
  console.log(form);
  useQuery({
    queryKey: ["sport_provider", providerId],
    queryFn: () =>
      getRequest({
        url: BASE_URL + API_LIST.GET_SPORT_PROVIDER,
        params: { id: providerId },
        errorMessage: "Failed to fetch sport_provider details",
  ...
  const mutation = useMutation({
    mutationFn: async (formData) => {
      ...
      return await postRequest({
        url: BASE_URL + API_LIST.CREATE_SPORT_PROVIDER,
        body: payload,
    ...
    <div className="bg-[#f5f5f5] min-h-screen p-6">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-semibold uppercase">
          {isParentProvider
            ? providerId
              ? "Edit Sport Parent Provider"
              : "Add Sport Parent Provider"
            : providerId
            ? "Edit Sport Provider"
            : "Add Sport Provider"}
        </h2>
        ...
        >
          ...
          <div className="md:col-span-2 flex justify-end mt-2">
            {!isParentProvider && parentProviderList.length < 1 ? (
              ...
              >
                Add Parent Sport Provider First
              </button>
            ) : (
              <button
                type="submit"
...
export default AddSportProviderForm;
