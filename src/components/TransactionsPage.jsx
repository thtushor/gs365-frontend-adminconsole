...
const TransactionsPage = ({ playerId: propPlayerId, title = "Transactions" }) => {
        ...
        {playerId && (
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3">
           <input
             ...
             placeholder={playerId ? "Search by transaction ID" : "Search by id/user"}
               ...
               <div className="flex items-center justify-between">
                 ...
                 <div className="text-right">
                   <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                     selectedTx.status === 'approved' ? 'bg-green-100 text-green-800' :
                 ...
                 <div className="bg-white border rounded-lg p-4">
                   ...
                   <div className="space-y-3">
                     ...
                     <div className="flex justify-between">
                       ...
                       <span className="font-medium">{selectedTx.currencyName} ({selectedTx.currencyCode})</span>
                     </div>
                     <div className="flex justify-between">
                       <span className="text-gray-600">Created:</span>
                       <span className="font-medium">{formatDateTime(selectedTx.createdAt)}</span>
                     </div>
                     <div className="flex justify-between">
                       <span className="text-gray-600">Processed:</span>
                       <span className="font-medium">{formatDateTime(selectedTx.processedAt)}</span>
                     </div>
                   </div>
                 </div>
                     ...
                     <div className="space-y-3">
                       {selectedTx.accountNumber && (
                         <div className="flex justify-between">
                           ...
                           <span className="font-medium">{selectedTx.accountNumber}</span>
                         </div>
                       )}
                       {selectedTx.accountHolderName && (
                         <div className="flex justify-between">
                           <span className="text-gray-600">Account Holder:</span>
                           <span className="font-medium">{selectedTx.accountHolderName}</span>
                         </div>
                       )}
                       {selectedTx.bankName && (
                         <div className="flex justify-between">
                       ...
                       {selectedTx.walletAddress && (
                         <div className="flex justify-between">
                           ...
                           <span className="font-medium text-xs break-all">{selectedTx.walletAddress}</span>
                         </div>
                       )}
                       {selectedTx.network && (
                         <div className="flex justify-between">
                 ...
                 <div className="bg-white border rounded-lg p-4">
                   ...
                   <div className="space-y-3">
                     ...
                     <div className="flex justify-between">
                       ...
                       <span className="font-medium">@{selectedTx.userUsername}</span>
                     </div>
                     <div className="flex justify-between">
                       <span className="text-gray-600">Email:</span>
                       <span className="font-medium">{selectedTx.userEmail}</span>
                     </div>
                     <div className="flex justify-between">
                       <span className="text-gray-600">Phone:</span>
                       <span className="font-medium">{selectedTx.userPhone}</span>
                     </div>
                     <div className="flex justify-between">
                       <span className="text-gray-600">Status:</span>
                       <span className={`px-2 py-1 rounded text-xs font-medium ${
                         selectedTx.userStatus === 'active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                       }`}>
                     ...
                     <div className="flex justify-between">
                       ...
                       <span className={`px-2 py-1 rounded text-xs font-medium ${
                         selectedTx.userIsVerified ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                       }`}>
                   ...
                   <div className="bg-white border rounded-lg p-4">
                     ...
                     <div className="space-y-3">
                       <div className="flex justify-between">
                         ...
                         <span className="font-medium">{selectedTx.gameName}</span>
                       </div>
                       {selectedTx.gameStatus && (
                         <div className="flex justify-between">
                           <span className="text-gray-600">Game Status:</span>
                           <span className="font-medium">{selectedTx.gameStatus}</span>
                         </div>
                       )}
                     </div>
                   </div>
