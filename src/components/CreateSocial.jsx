...
const CreateSocial = ({ bannerToEdit, handleCancelEdit, onSuccess }) => {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      const url = BASE_URL + API_LIST.CREATE_UPDATE_SOCIAL;
      ...
      setSelectedSport(null);
      setErrorMsg("");
      setResponse({ status: true, message: "Social saved successfully!" });
    } catch (err) {
  ...
  return (
    <div>
      <h2 className="text-[20px] font-semibold mb-4 text-left">
        {bannerToEdit ? "Edit Social Platform" : "Create Social Platform"}
      </h2>
      ...
      <form onSubmit={handleUpload}>
        <input
          ...
          placeholder="Enter social media name (ex: Facebook, Twitter)"
