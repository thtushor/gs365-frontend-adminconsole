      ...
      <div className="p-6">
        <div className="bg-red-50 border border-red-200 rounded-md p-4">
          <h3 className="text-red-800 font-medium">
            Error loading gateway providers
          </h3>
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Gateway Providers</h1>
        <button
      ...
      {isLoading ? (
        ...
        <p className="text-center text-gray-500">No gateway providers found.</p>
      ) : (
        <>
          <DataTable
      ...
      <ReusableModal
        ...
        title={
          isEditMode ? "Edit Gateway Provider" : "Assign Provider to Gateway"
        }
        onSave={handleSubmit}
        isLoading={
          isEditMode
...
export default GatewayProvidersPage;
