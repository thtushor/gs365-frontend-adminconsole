...
import { useBetResults, useGames } from "../hooks/useBetResults";
import { FaFilter, FaEye } from "react-icons/fa";
import StatusChip from "./shared/StatusChip";
import Pagination from "./Pagination";

const PlayerWagerTab = ({ selectedPlayerId }) => {
  ...
  // Fetch bet results for the selected player
  const { data: betResults, isLoading: betResultsLoading } = useBetResults({
    ...filters,
    userId: selectedPlayerId,
    page: currentPage,
    pageSize,
  ...
  if (!selectedPlayerId) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[200px] text-gray-500">
        ...
        <div className="text-lg font-semibold">Player Wagers</div>
        <div className="mt-2">Select a player to view their wager details.</div>
      </div>
    );
  }
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg shadow p-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-semibold">Wager Filters</h3>
        </div>
              ...
              {betResultsLoading ? (
                <tr>
                  <td colSpan="10" className="px-6 py-4 text-center text-gray-500">
                    Loading wager results...
                  </td>
                </tr>
              ) : betResultsList.length === 0 ? (
                <tr>
                  <td colSpan="10" className="px-6 py-4 text-center text-gray-500">
                    No wager results found for this player
                  </td>
                </tr>
              ) : (
