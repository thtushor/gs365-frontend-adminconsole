const AllWithdrawFilter = () => (
  <form className="flex flex-wrap gap-2 items-center mb-4">
    ...
    <input
      ...
      className="border rounded px-3 py-2 text-sm w-40 focus:outline-none focus:ring-2 focus:ring-green-200"
    />
    <select className="border rounded px-3 py-2 text-sm w-40 focus:outline-none focus:ring-2 focus:ring-green-200">
...
export default AllWithdrawFilter;
