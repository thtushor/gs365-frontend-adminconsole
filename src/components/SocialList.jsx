...
const SocialList = () => {
  ...
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["social", filters],
    queryFn: () =>
      getRequest({
        url: BASE_URL + API_LIST.GET_SOCIAL,
        params: filters,
        errorMessage: "Failed to fetch social list",
      }),
    ...
    <div className="w-full p-5 bg-white rounded-xl border border-green-300">
      ...
      <div className="mt-5 border border-gray-300 p-5 rounded-lg">
        ...
        {isLoading ? (
          ...
          <div className="text-center text-gray-500">
            No social platform found.
          </div>
        ) : (
          <div className="">
            <DataTable columns={columns} data={social} />
            <Pagination
