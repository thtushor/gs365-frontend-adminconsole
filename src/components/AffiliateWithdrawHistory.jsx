...
const AffiliateWithdrawRequestListPage = ({ title = "Withdraw History" }) => {
  ...
  const handleUpdate = async () => {
    const dynamicUrl = `${API_LIST.WITHDRAW_TRANSACTION}/${selectedTx.id}/status`;
                ...
                <div className="bg-white border rounded-lg p-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      >
                        {selectedTx.affiliateName}
                      </button>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Username:</span>
                      <span className="font-medium">
                        @{selectedTx.affiliateUsername}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Email:</span>
                      <span className="font-medium">
                        {selectedTx.affiliateEmail}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Phone:</span>
                      <span className="font-medium">
                        {selectedTx.affiliatePhone}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Register Date:</span>
                      <span className="font-medium">
                        {formatDate(selectedTx.affiliateRegisterDate || false)}
                      </span>
                    </div>
                    <div className="flex justify-between">
...
export default AffiliateWithdrawRequestListPage;
